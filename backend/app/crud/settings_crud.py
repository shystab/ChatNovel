...
def update_settings(session: Session, settings_data: SettingUpdate) -> Setting:
    ...
    if db_settings:
        ...
        db_settings = Setting(
            ...
            background_image_path=update_data.get("background_image_path"),
            background_blur=update_data.get("background_blur", 0),
            background_dim=update_data.get("background_dim", 22),
            editor_paper_opacity=update_data.get("editor_paper_opacity", 92),
